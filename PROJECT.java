//COLLEGE MANAGEMENT SYSTEM_EXCEPTION
//By:- Arshu Hamid, Avinash Tiwari, Himanshu Sharma, Shashank Singh
import java.awt.*;
import java.awt.event.*;
import java.io.*;

public class  PROJECT//#METHORD
{
Frame f;
Label ml,rl1,rl2,rl3,rl4,rl5,h1,h2,h3,h4,h5,h6,h7,h8,cl1,cl2,cl3,cl4,cl5,cl6,cl7,cl8,T;
TextField rt1,rt2,rt3,rt4,rt5,ht,ct1,ct2,ct3,ct4; TextField t1,t2,t3,t4,t5,t6,t7,t8,t9,
...
rb1=new Button("Add"); //add button
rb1.setBounds(40,310,50,36);
rb2=new Button("Reset"); //reset button
rb2.setBounds(130,310,50,36);

//NOTICE
hb=new Button("Notice Highlights"); //notice button
...
//LIBRARY DUES
cl1= new Label("Check Library Dues");
...
T=new Label("Programmed by:- Arshu Hamid, Avinash Tiwari"); //PRESENTED BY
T.setBounds(700,535,300,13);
...
//add right
f.add(ml);
f.add(rl1); f.add(rt1); f.add(rl2); f.add(rt2); f.add(rl3); f.add(rt3);
f.add(rl4); f.add(rt4); f.add(rl5); f.add(rt5); f.add(rb1); f.add(rb2);
//add notice
f.add(hb); f.add(ht);
//add details
...
f.add(t11); f.add(t12); f.add(t13); f.add(t14); f.add(t15); f.add(t16); f.add(t17); f.add(t18); f.add(t19); f.add(t20);
f.add(t21); f.add(t22); f.add(t23); f.add(t24); f.add(t25); f.add(t26); f.add(t27); f.add(t28); f.add(t29); f.add(t30);
f.add(t31); f.add(t32); f.add(t33); f.add(t34); f.add(t35); f.add(t36); f.add(t37); f.add(t38); f.add(t39); f.add(t40);
f.add(t41); f.add(t42); f.add(t43); f.add(t44); f.add(t45); f.add(t46); f.add(t47); f.add(t48); f.add(t49); f.add(t50);
f.add(t51); f.add(t52); f.add(t53); f.add(t54); f.add(t55); f.add(t56); f.add(t57); f.add(t58); f.add(t59); f.add(t60);
f.add(t61); f.add(t62); f.add(t63); f.add(t64); f.add(t65); f.add(t66); f.add(t67); f.add(t68); f.add(t69); f.add(t70);
// add below details
f.add(db); f.add(cb); f.add(cb1);
//add library
f.add(cl1); f.add(cl2); f.add(ct1); f.add(cl3); f.add(ct2); f.add(sb); f.add(cl4);
//add fee
f.add(cl5); f.add(cl6); f.add(ct3); f.add(cl7); f.add(ct4); f.add(cb2); f.add(cl8); f.add(T);

f.setSize(1000,800);
f.setLayout(null);
f.setVisible(true);

f.addWindowListener( new WindowAdapter()	//for closing window
{
...
//reset button
rb2.addActionListener(new ActionListener(){    //For cleaning entered data
public void actionPerformed(ActionEvent e){
rt1.setText(" "); rt2.setText(" "); rt3.setText(" "); rt4.setText(" "); rt5.setText(" ");
}});

//Clear button
cb.addActionListener(new ActionListener(){    //For cleaning added data
public void actionPerformed(ActionEvent e){
t13.setText(" "); t20.setText(" "); t27.setText(" ");
t34.setText(" "); t41.setText(" "); t48.setText(" ");
t55.setText(" "); t62.setText(" "); t69.setText(" ");
;}
});


//Clear all button
cb1.addActionListener(new ActionListener(){    //For cleaning whole data
public void actionPerformed(ActionEvent e){
...
//Students name
	...
	t11.setText("Shashank Singh"); t12.setText("Amit Mishra");
//id colege
	t15.setText("61210006");
	t16.setText("61210103");
	t17.setText("61210007");
	t18.setText("61210009");
	t19.setText("612100010");
//branch
	t22.setText("CSE");
	t23.setText("CSE");
	t24.setText("CSE");
	...
	t26.setText("CSE");
//University roll no
	t29.setText("2103420100036");
	t30.setText("2103420100030");
	t31.setText("2103420100048");
	t32.setText("2103420100123");
	t33.setText("2103420100342");
//college name
	t36.setText("UCER");
	t37.setText("UCER");
	t38.setText("UCER");
...
//#DISPLAY DETAILS
    ...
    fin.close();
	 ...
	 try //display Branch
     {
	 FileInputStream fin=new FileInputStream("branch.txt");
     int i=0;
    String txt="";
    while((i=fin.read())!=-1)
	{
    ...
    fin.close();
	 ...
	 try //display University no.
     {
	 FileInputStream fin=new FileInputStream("univ.txt");
     int i=0;
    String txt="";
    while((i=fin.read())!=-1)
	{
    ...
    fin.close();
	 ...
	 try //display Clg name
     {
	 FileInputStream fin=new FileInputStream("clg.txt");
     int i=0;
    String txt="";
    while((i=fin.read())!=-1)
	{
...
public void actionPerformed(ActionEvent e){
cl4.setText("No weekly due found.");
}});

//check button for fee status
cb2.addActionListener(new ActionListener(){
public void actionPerformed(ActionEvent e){
cl8.setText("Your 1st installment is paid.");
}});
...
//Notice button
hb.addActionListener(new ActionListener(){    //For displaying notice
public void actionPerformed(ActionEvent e){
ht.setText("#Odd semester begins soon....");
;}
});
...
public void actionPerformed(ActionEvent e){
    try//Add name
	 ...
	 try//Add Branch
     {
	 FileOutputStream fout=new FileOutputStream("branch.txt");
     String s=rt3.getText();
     byte b[]=s.getBytes();
     fout.write(b);
     fout.close();
	 ...
	 try//Add University no.
     {
	 FileOutputStream fout=new FileOutputStream("univ.txt");
     String s=rt4.getText();
     byte b[]=s.getBytes();
     fout.write(b);
     fout.close();
	 ...
	 try//Add Clg name
     {
	 FileOutputStream fout=new FileOutputStream("clg.txt");
     String s=rt5.getText();
     byte b[]=s.getBytes();
     fout.write(b);
     fout.close();
